...
#filename='/Quantum_Results/Quantum Results U_6_t_gnoise_test_gnoise'
filename='/Quantum_Results/Quantum Results U_6_t_pnoise_test_pnoise 0.8'
...
for p in freqs:
    ...
    #dataset = sin_generator.sin_gen3(1,10000)
    print('Gaussian')
    Benchmarking_pn_gn.Benchmarking_vs1(dataset, Unitaries, U_num_params, filename, circuit='QCNN', steps = 200, snr=p, binary=binary)
